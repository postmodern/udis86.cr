...
module UDis86
  class UD
    ...
    #
    def self.create(mode : UInt8 = 64, vendor : Symbol? = nil, syntax : Symbol? = nil, pc : UInt64? = nil, buffer : String? = nil)
      ud = new
    ...
    def input_index : SizeT?
      unless @ud.inp_buf.null?
        @ud.inp_buf_index
      end
    end

    def input_size : SizeT?
      unless @ud.inp_buf.null?
        @ud.inp_buf_size
      end
    end
